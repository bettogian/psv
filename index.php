                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Oraciones (Minutos)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">240 min</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Sacramentos
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Nuestra Barquita</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="col-lg-6 col-12" style="float:left;">
                                        ...
                                        <div class="text-center">
                                            <img class="img-fluid" style="width: 100%;"
                                                src="img/banner-barquita-002.jpg" alt="...">
                                        </div>
                                    </div>

                                    <div class="col-lg-6 col-12" style="float:left;">
                                    <p>Bienvenidos a nuestra barquita hermanos,<br>en esta aplicación web, podemos registrar en línea y recurrentemente las incidencias de nuestras Hojas de Dicipulado, en sus secciones de Oraciones (Individual y en Pareja), Citas, Sacramentos y Rosarios.</p>
                                    <p>Bnediciones.</p>
                                    </div>
